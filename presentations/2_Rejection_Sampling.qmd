...
- Profiles on the next slide due to error in presentation render
...
ppa_precise <- poisson_prior_approximation(breaks = c(0, 1, 2, 3, 4), order = 4)
ppa_imprecise <- poisson_prior_approximation(breaks = c(0, 4), order = 4)
